...
def gain():
    suka = main()
    print(suka.has_max_out_edges())
    print(suka.select('exit'))
    print(suka.select('share'))
    print(suka.select('exit'))
    print(suka.select('amass'))
    print(suka.has_path_to('K1'))
    print(suka.select('close'))
    print(suka.select('bend'))
    print(suka.select('view'))
    #assert suka.has_path_to('K5')
